      ...
      await new Promise<void>((resolve) => {
        test$.subscribe({
          next: (msg) => {
            ...
            expect(msg.body).toBeDefined()
            expect(msg.commitment).toBeDefined()
            expect(msg.commitment).toBe('0x036dcfb09fdc66d17657146ba7f03b69f37408545dc3409c56694e340f720e2c')
            expect(msg.nonce).toBeDefined()
            expect(msg.from).toBeDefined()
            expect(msg.to).toBeDefined()
            expect(msg.blockHash).toBeDefined()
      ...
      await new Promise<void>((resolve) => {
        test$.subscribe({
          next: (msg) => {
            ...
            expect(msg.body).toBeDefined()
            expect(msg.commitment).toBeDefined()
            expect(msg.commitment).toBe('0xc920550a331335fbc2b1b6042d5bbdb907a025bf113487b695fe3dbfff99f188')
            expect(msg.nonce).toBeDefined()
            expect(msg.from).toBeDefined()
            expect(msg.to).toBeDefined()
            expect(msg.blockHash).toBeDefined()
