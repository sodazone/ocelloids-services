...
export async function up(db: Kysely<any>): Promise<void> {
  try {
    ...
    await db.schema
      ...
      .addColumn('from_prefix', 'varchar(42)')
      .addColumn('to_prefix', 'varchar(42)')
      .addColumn('sent_at', 'bigint')
      .addColumn('recv_at', 'bigint')
      .addColumn('created_at', 'bigint', (cb) => cb.notNull())
      .addColumn('stops', 'text', (cb) => cb.notNull())
      .addColumn('instructions', 'text', (cb) => cb.notNull())
      .addColumn('transact_calls', 'text', (cb) => cb.notNull())
    ...
    await db.schema
      ...
      .addColumn('snapshot_start', 'bigint', (col) => col.notNull())
      .addColumn('snapshot_end', 'bigint', (col) => col.notNull())
      .execute()
